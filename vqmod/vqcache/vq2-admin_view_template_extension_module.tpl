        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php if ($extensions) { ?>
                <style>.list tbody tr:nth-child(2n), .list tbody td{background:none}.highlight{background:#f4ffed !important;border-left: 5px solid #b1db95 !important; border-right: 5px solid #b1db95 !important;}</style><style>.list tbody tr:nth-child(2n), .list tbody td{background:none}.highlight{background:#f4ffed !important;border-left: 5px solid #b1db95 !important; border-right: 5px solid #b1db95 !important;}</style><?php foreach ($extensions as $extension) { ?>
          <tr<?php echo (count($extension['action']) >= 2)?' class="highlight"':''; ?>>
